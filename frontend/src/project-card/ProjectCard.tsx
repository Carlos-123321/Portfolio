        ...
        <>
            <div className={projectCardStyles.projectCardContainer}>
                ...
                <div className={projectCardStyles.projectCardContent}>
                    ...
                    <div className={projectCardStyles.pencilButtonContainer} style={{marginTop: '3%'}}>
                        <svg onClick={() => setIsModalOpen(true)} xmlns="http://www.w3.org/2000/svg" width="16"
                             height="16" fill="currentColor"
                             className={projectCardStyles.eyeButton} viewBox="0 0 16 16">
                        ...
                        {githubLink && (
                            <a href={githubLink} target="_blank" rel="noopener noreferrer"
                               style={{all: 'unset', display: 'inline-block'}}>
                                <svg className={projectCardStyles.pencilButton} xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg onClick={() => {
                            setIsUpdateModalOpen(true);
                             ...
                             className={projectCardStyles.pencilButton} viewBox="0 0 16 16">
                            <path
